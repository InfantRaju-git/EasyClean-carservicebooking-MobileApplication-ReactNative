...
export default class dashboard extends Component {
  ...
  render() {
    ...
    <Picker 
      ...
      <Picker.Item label="Select Add on services" value="" />
    ...
    <View style={styles.myButton}>
       <Text style={styles.text2} onPress={this.BookRequest} textAlign='center'>     Book</Text>
     </View>
      </View>
    );
  }
